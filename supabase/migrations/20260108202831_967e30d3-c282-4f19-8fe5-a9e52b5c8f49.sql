-- Update create_admin_templates function to use dynamic {valor} variable instead of fixed R$ 25,00
...
-- Update existing admin templates to use {valor} variable
UPDATE public.whatsapp_templates 
SET message = REPLACE(message, 'R$ 25,00', '{valor}')
WHERE name LIKE 'Vendedor%';